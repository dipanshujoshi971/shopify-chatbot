...
export function buildSystemPrompt(
  ...
  const lines = [
    ...
    '## Available Tools',
    '',
    '### Product Search — search_shop_catalog',
    ...
    '- If you don\'t have a variant_id, call search_shop_catalog FIRST.',
    ...
    '4. If NO: call search_shop_catalog first, then use the variant_id from results.',
    '5. If multiple variants exist (sizes/colors), ask customer which one.',
    '6. After adding, confirm what was added and offer the checkout link.',
    ...
    '- When cart data is returned, keep text minimal. The cart card is shown automatically.',
    '- When order data is returned, keep text minimal. The order card is shown automatically.',
